...
const kGoogleApiKey =
    'AIzaSyCvNwLmsOHNMr6seH8HDvJBexyqtQ00UYM'; // Replace with your API key
...
class _TestingMapsState extends State<TestingMaps> {
  ...
  Future<void> _handleSearch() async {
    ...
    if (p != null) {
      print(
        "Prediction selected--------> ${p.description} (Place ID----> ${p.placeId})",
      );
      ...
      print(
        "Selected place coordinates: Latitude -------> $lat, Longitude = $lng",
      );
